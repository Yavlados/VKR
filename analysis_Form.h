...
signals:
    ...
    void Send_short_face_analysis_all_db(QDate, QDate, int);

    void Send_short_tel_analysis_all_db(QDate, QDate, int);

    void Send_long_face_analysis_all_db(QDate, QDate, int);

    void Send_long_tel_analysis_all_db(QDate, QDate, int);
