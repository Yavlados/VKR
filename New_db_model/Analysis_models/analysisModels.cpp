...
{
    QString mainQuery = this->v1(eventId);
...
{
     QString mainQuery = this->v2(eventId);
...
{
    QString mainQuery = this->v3(eventId);
...
QString AnalysisModels::v1(QString eventId, QMap<QString, QString> *period)
{
    QString mainQuery = this->v1(eventId);

    QString startPeriod = period->value("start");
    QString endPeriod = period->value("end");

    mainQuery += "AND ( e.detention_date BETWEEN ";
    if(startPeriod == "")  mainQuery += "'01.01.1900'";
    else mainQuery += "'"+startPeriod+"'";

    mainQuery += " AND ";

    if(endPeriod == "")  mainQuery += "'31.12.2100'";
    else mainQuery += "'"+endPeriod+"'";
...
QString AnalysisModels::v2(QString eventId, QMap<QString, QString> *period)
{
    QString mainQuery = this->v2(eventId);
    ...
    mainQuery += "AND ( event.detention_date BETWEEN ";
    if(startPeriod == "")  mainQuery += "'01.01.1900'";
    else mainQuery += "'"+startPeriod+"'";
...
QString AnalysisModels::v3(QString eventId, QMap<QString, QString> *period)
{
    QString mainQuery = this->v3(eventId);
