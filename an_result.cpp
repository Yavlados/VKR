...
void An_result::Recieve_short_face_analysis_all_db(QDate dateFROM, QDate dateTO, int id)
{
    For_analysis *an = new For_analysis();
...
void An_result::Recieve_short_tel_analysis_all_db(QDate dateFROM, QDate dateTO, int id)
{
    For_analysis *an = new For_analysis();
...
void An_result::Recieve_long_face_analysis_all_db(QDate dateFROM, QDate dateTO, int id)
{
    For_analysis *an = new For_analysis();
...
void An_result::Recieve_long_tel_analysis_all_db(QDate dateFROM, QDate dateTO, int id)
{
    For_analysis *an = new For_analysis();
